...
// PortBridgeServiceSpec defines the desired state of PortBridgeService
type PortBridgeServiceSpec struct {
	// INSERT ADDITIONAL SPEC FIELDS - desired state of cluster
	// Important: Run "make" to regenerate code after modifying this file

	// Foo is an example field of PortBridgeService. Edit portbridgeservice_types.go to remove/update
	Foo string `json:"foo,omitempty"`
}

// PortBridgeServiceStatus defines the observed state of PortBridgeService
...
type PortBridgeService struct {
	...
	Status PortBridgeServiceStatus `json:"status,omitempty"`
}
